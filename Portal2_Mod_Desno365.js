...
// ui varaibles
var buttonsSize = Math.round(deviceDensity - 1) / 10;
...
function useItem(x, y, z, itemId, blockId, side, itemDamage)
{
	...
	// radio
	if(blockId >= PORTAL_RADIO_A && blockId <= PORTAL_RADIO_D)
	{
		preventDefault();
		try
		{
					...
					if(!fireButtonsInitialized)
					{
						...
						onClick: function()
						{
							if(portalShotOrange.size() < 1)
							{
								...
								var speedO = getPortalGunBulletSpeed();
						...
						onClick: function()
						{
							if(portalShotBlue.size() < 1)
							{
								...
								var speedB = getPortalGunBulletSpeed();
...
function getPortalGunBulletSpeed()
{
	if(Player.getCarriedItem() == ID_PORTAL_GUN_BLUE)
		return 3;
	if(Player.getCarriedItem() == ID_PORTAL_GUN_ORANGE)
	...
	currentActivity.runOnUiThread(new java.lang.Runnable()
	{
		run: function()
		{
			try
			{
				...
				var button2 = minecraftButton("Subscribe to my YouTube channel");
